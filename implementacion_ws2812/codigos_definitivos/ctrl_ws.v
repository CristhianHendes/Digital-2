// =============================================================
// ctrl_ws.v - Maquina de estados del temporizador de un bit.
// Implementa el diagrama "FSM(send1_0).jpg": genera el pulso
// DOUT con el ancho correcto (T0H/T1H/RES) segun SEL.
// =============================================================
module ctrl_ws (
    input             clk,
    input             reset,
