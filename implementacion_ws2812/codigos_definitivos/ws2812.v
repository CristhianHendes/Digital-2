// =============================================================
// ws2812.v - Datapath + control del temporizador de un bit.
// Modulo "ws2812" de Diagramas_datapath.pdf / FSM(send1_0).jpg.
// Genera un pulso DOUT de ancho T0H, T1H o RES segun sel.
// =============================================================
module ws2812 (
    input        clk,
    input        reset,
