// =============================================================
// ws2812_led.v - Envia los 24 bits (RGB) de un unico LED.
// Corresponde al bloque "ws2812_led" de Diagramas_datapath.pdf,
// controlado por ctrl_wsled.v (FSM(rest).jpg) y que a su vez usa
// ws2812.v (FSM(send1_0).jpg) para generar cada pulso de bit.
// =============================================================
module ws2812_led (
    input        reset,
    input        clk,
