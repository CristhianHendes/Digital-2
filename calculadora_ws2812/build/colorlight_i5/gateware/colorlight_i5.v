    ...
    if (disp0_start_wr_stb) begin
        ...
        if (disp0_loading) begin
            if ((disp0_sink_valid & disp0_sink_ready)) begin
                disp0_w_data <= {disp0_sink_payload_data[23:16], disp0_sink_payload_data[15:8], disp0_sink_payload_data[31:24]};
                disp0_w_address <= disp0_addr;
                disp0_we <= 1'd1;
                if ((disp0_addr == 6'd63)) begin
                    disp0_addr <= 1'd0;
                    disp0_loading <= 1'd0;
                    disp0_done <= 1'd1;
...
//------------------------------------------------------------------------------
// Instance div_32 of div_32 Module.
//------------------------------------------------------------------------------
div_32 div_32(
	// Inputs.
	.A    (div0__A_storage),
	.B    (div0__B_storage),
	.clk  (sys_clk),
	.init (div0_init_storage),
	.rst  (sys_rst),

	// Outputs.
	.done (div0_done_status),
	.q    (div0__q_status),
	.r    (div0__r_status)
);

//------------------------------------------------------------------------------
// Instance add_32 of add_32 Module.
//------------------------------------------------------------------------------
add_32 add_32(
	// Inputs.
	.A   (add0__A_storage),
...
//------------------------------------------------------------------------------
// Instance sub_32 of sub_32 Module.
//------------------------------------------------------------------------------
sub_32 sub_32(
	// Inputs.
	.A    (sub0__A_storage),
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2026-07-22 13:18:39.
//------------------------------------------------------------------------------
