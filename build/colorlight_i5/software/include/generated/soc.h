...
#define CONFIG_IDENTIFIER "LiteX SoC on Colorlight I9 2026-07-16 10:12:38"
...
static inline const char * config_identifier_read(void) {
	return "LiteX SoC on Colorlight I9 2026-07-16 10:12:38";
}
...
static inline uint32_t localip1_read(void) {
	return 192;
}
static inline uint32_t localip2_read(void) {
	return 168;
}
static inline uint32_t localip3_read(void) {
	return 1;
}
static inline uint32_t localip4_read(void) {
	return 50;
}
static inline uint32_t remoteip1_read(void) {
	return 192;
}
static inline uint32_t remoteip2_read(void) {
	return 168;
}
static inline uint32_t remoteip3_read(void) {
	return 1;
}
static inline uint32_t remoteip4_read(void) {
	return 100;
}
